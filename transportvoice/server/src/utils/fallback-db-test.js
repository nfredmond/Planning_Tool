...
const fallback_mongo_client_1 = require("./fallback-mongo-client");
...
async function testFallbackConnection() {
    ...
    try {
        ...
        const client = await (0, fallback_mongo_client_1.connectMongoFallback)();
        ...
        await (0, fallback_mongo_client_1.closeMongoFallback)();
        console.log('\nConnection closed.');
    }
    catch (error) {
